                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Agregar grupo</h2>
                                </div>
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong></strong><?php echo htmlentities($msg); ?>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Carrera</label>
                                                		<div class="">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nombre grupo en numero</label>
                                                        <div class="">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Enviar<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
