                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Admision de estudiantes</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Admision de estudiantes </li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Agrega la informacion del estudiante</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Matricula ultimos 4 digitos</label>
<div class="col-sm-10">
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Correo electrónico</label>
<div class="col-sm-10">
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); ?>&nbsp; Edificio-<?php echo htmlentities($result->Section); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
