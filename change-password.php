 ...
 <strong>Exitoso</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                    ...
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Confirmar</label>
                                                        <div class="">
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-labeled">Cambiar<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
